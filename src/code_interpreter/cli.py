...
# import src.dsl.solvers as arc_solvers
...
#             return (
#                 f"# No solver found for task ID: {task_id}\ndef solve(I):\n    return I"
#             )
...
#     task_data: Dict[str, Any], task_id: str
# ) -> List[List[List[int]]]:
...
#         None, "--task", help="Path to task file (defaults to src/tasks/*.json)"
#     ),
